...
namespace Fantasy_Chess_Game
{
    class Properties_Blue
    {
        ...
        public Properties_Blue(string name, byte life, byte shield, byte shot, byte y_coordinate, byte x_coordinate, byte steps, byte y_coordinate_now, byte x_coordinate_now)
        {
            Name = name;
            Life = life;
            Shield = shield;
